...
export default class Persyaratan extends React.Component {
  constructor(props) {
    super(props);
      ...
      dataPengajuan: [
        {
          ...
          navigation: 'SuratKeteranganDomisili',
        },
        {
          title: 'Surat Keterangan SKCK',
          navigation: 'SuratKeteranganSKCK',
        },
        {
          title: 'Surat Keterangan Kelahiran',
          navigation: 'SuratKeteranganKelahiran',
        },
        {
    ...
    if (this.state.default === 'pengajuan') {
      return (
        <View
          ...
          <TouchableOpacity
            onPress={() => this.setState({default: 'persyaratan'})}
            style={{
              height: 40,
              width: '30%',
              margin: 10,
