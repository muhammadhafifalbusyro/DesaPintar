...
export default class SuratKeteranganKelahiran extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={style.container}>
        ...
        <ScrollView style={{flex: 1, padding: 10}}>
          <Text style={{fontWeight: 'bold'}}>Data Bayi</Text>
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Nama ayah - nama anak</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Tempat Dilahirakan</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Tempat Kelahiran</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Jenis Kelahiran</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Kelahiran Ke -</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Penolong Kelahiran</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Berat Bayi</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Panjang Bayi</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Nama Keluarga</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Nomor Kartu Keluarga</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('DataIbu')}
              style={{
                height: 40,
                width: '90%',
                backgroundColor: '#2fc7ae',
