...
export default class DataIbu extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={style.container}>
        ...
        <ScrollView style={{flex: 1, padding: 10}}>
          <Text style={{fontWeight: 'bold'}}>Data Ibu</Text>
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Umur</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Kewarganaegaraan</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Kebangsaan</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View style={{width: '100%', marginBottom: 10}}>
            <Text style={{marginBottom: 3}}>Tanggal Pencatatan Perkawinan</Text>
            <TextInput
              style={{
                height: 40,
                width: '100%',
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate('DataAyah')}
              style={{
                height: 40,
                width: '90%',
                backgroundColor: '#2fc7ae',
